...
CREATE TABLE `manager` (
  ...
  KEY `ManagerUK_7s8r05ax2bur4f048d48vaer6` (`name`,`userAccount_id`),
...
--
-- Dumping data for table `rendezvous_request`
--

LOCK TABLES `rendezvous_request` WRITE;
/*!40000 ALTER TABLE `rendezvous_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `rendezvous_request` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `request` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_b4s1c0krw9cr1g7apdnf809hd` (`services_id`),
  CONSTRAINT `FK_b4s1c0krw9cr1g7apdnf809hd` FOREIGN KEY (`services_id`) REFERENCES `services` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `services` (
  ...
  `rendezvous_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_9bwbccfrde1xantrcgtxhpgbi` (`manager_id`),
  KEY `FK_hs3p0i2pnn6m0l7d84sajeykv` (`rendezvous_id`),
  CONSTRAINT `FK_hs3p0i2pnn6m0l7d84sajeykv` FOREIGN KEY (`rendezvous_id`) REFERENCES `rendezvous` (`id`),
  CONSTRAINT `FK_9bwbccfrde1xantrcgtxhpgbi` FOREIGN KEY (`manager_id`) REFERENCES `manager` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `services_category` (
  ...
  KEY `FK_i27ple8svpdliq733o0pfreo3` (`category_id`),
  KEY `FK_9pu8ovxybbmdao0ciaocxh4qi` (`services_id`),
  CONSTRAINT `FK_9pu8ovxybbmdao0ciaocxh4qi` FOREIGN KEY (`services_id`) REFERENCES `services` (`id`),
  CONSTRAINT `FK_i27ple8svpdliq733o0pfreo3` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
